...
import com.common.plugins.rapidframework.ConvertRegisterHelper;
import com.common.plugins.rapidframework.PageQueryFactory;
...
public class BaseRestSpringController<Entity, PK> {
	...
	protected final static String DATE_FORMAT_STR="yyyy-MM-dd";
	protected final static String DATETIME_FORMAT_STR="yyyy-MM-dd HH:mm:ss";
